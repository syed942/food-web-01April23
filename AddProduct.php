...
//$sql = mysqli_query($conn, "insert into user1 (userId,name,image) values(null,'imran shah','kki')");
 //$trp = mysqli_query($conn, "insert into product  values(null,'${name}',${price},'${Imgname1}')");
 $trp = mysqli_query($conn, "insert into product (productId,name,price,image) values(null,'${name}',${price},'${Imgname1}')");
